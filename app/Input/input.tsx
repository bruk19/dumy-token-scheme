...
const InputField: React.FC<InputFieldProps> = ({
  ...
  return (
    <div className="relative w-[90%] z-9">
      <input
        className={`h-[60px] bg-[#0F0F0F] placeholder:text-[#5C5C5C] placeholder:font-Geist placeholder:text-[12px] placeholder:leading-[14.88px] text-primary px-2 ${className}`}
        type="text"
